...
export GEOMETRY_MIN_WIDTH_RATIO GEOMETRY_MIN_HEIGHT_RATIO GEOMETRY_MIN_AREA_RATIO
export GEOMETRY_X_PADDING_PX GEOMETRY_MORPHOLOGY_KERNEL_PX GEOMETRY_EDGE_ROI_PADDING_PX
export DARK_THRESHOLD CLOSE_KERNEL_RATIO MIN_AREA_RATIO SIDE_BAND_RATIO ROI_RADIUS_RATIO
export MIN_WHITE_RATIO MIN_WHITE_COMPONENT_RATIO
export MIN_WHITE_SHAPE_COMPONENT_RATIO MIN_WHITE_COMPONENT_DIAMETER_RATIO
export MIN_WHITE_CIRCULARITY MAX_WHITE_CENTER_OFFSET_RATIO
export MIN_BALL_RATIO MIN_YELLOW_COMPONENT_RATIO MIN_COLOR_MARGIN
